...
local keyboard = {
{'الاحصائيات ▪︎','قناه تحديثات البوت ▪︎'},
{'تعطيل التواصل ▪︎','تفعيل التواصل ▪︎'},
{'ضع اسم للبوت ▪︎','المطورين ▪︎','قائمه العام ▪︎'},
{'الثانويين ▪︎','مسح الثانويين ▪︎'},
{'المشتركين ▪︎','الجروبات ▪︎'},
{'ضع كليشه ستارت ▪︎','حذف كليشه ستارت ▪︎'},
{'اذاعه ▪︎','اذاعه خاص ▪︎'},
{'اذاعه بالتثبيت ▪︎','قائمه الكتم العام ▪︎'},
{'تغير رساله الاشتراك','حذف رساله الاشتراك ▪︎','تغير الاشتراك'},
{'اذاعه بالتوجيه ▪︎','اذاعه بالتوجيه خاص ▪︎'},
{'تفعيل الاشتراك الاجباري ▪︎','تعطيل الاشتراك الاجباري ▪︎'},
{'الاشتراك الاجباري ▪︎','وضع قناة الاشتراك ▪︎'},
{'تفعيل البوت الخدمي ▪︎','تعطيل البوت الخدمي ▪︎'},
{'تنظيف الجروبات ▪︎','تنظيف المشتركين ▪︎'},
{'تفعيل النسخه التلقائيه ▪︎','تعطيل النسخه التلقائيه ▪︎'},
{'تغيير المطور الاساسي ▪︎'}, 
{'جلب نسخه الاحتياطيه ▪︎'},
{'تحديث السورس ▪︎','الاصدار ▪︎'},
{'معلومات السيرفر ▪︎'},
{'الغاء ▪︎'},
}
...
send_inlin_key(msg.chat_id_,"*▪︎ هل تريد الغاء منع كل الصور؟*",Zs,msg.id_)
end
...
ZsText = "*▪︎ هل تريد الغاء منع كل المتحركات؟*"
Zs = {
...
if #list == 0 then
t = "*▪︎ لا يوجد الملصق ممنوعه*"
send(msg.chat_id_, msg.id_,t)  
return false
end
ZsText = "*▪︎ هل تريد الغاء منع كل الملصقات؟*"
Zs = {
...
if text == 'تفعيل التواصل ▪︎' and DevAfnanW(msg) then  
...
if text == 'تعطيل التواصل ▪︎' and DevAfnanW(msg) then  
...
if text == 'تفعيل البوت الخدمي ▪︎' and DevAfnanW(msg) then  
...
if text == 'تعطيل البوت الخدمي ▪︎' and DevAfnanW(msg) then  
...
if text == 'ضع كليشه ستارت ▪︎' and DevAfnanW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *٭ ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ▪︎' and DevAfnanW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *٭ تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ▪︎' and DevAfnanW(msg) then 
...
if text =='تغيير المطور الاساسي ▪︎' and SudoBot(msg) then
send(msg.chat_id_, msg.id_,'*٭  ارسل ايدي المطور الاساسي الجديد*')
database:set(bot_id..'Ed:DevBots',true) 
end
if text =='تغيير المطور الاساسي ▪︎' and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,'*٭ لا يمكنك تغيير المطور الاساسي*')
end
if text == 'تحديث السورس ▪︎' and DevAfnanW(msg) then 
...
if text == 'الاصدار ▪︎' and DevAfnanW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *٭ اصدار سورس Afnan* \n*٭ الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ▪︎' and DevAfnanW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ٭ [تحديثات البوت](t.me/saaaa) \n٭ [قناه السورس](t.me/saaaa)')
end
if text == "ضع اسم للبوت ▪︎" and DevAfnanW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *٭ ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ▪︎' and DevAfnanW(msg) then 
...
if text == 'المشتركين ▪︎' and DevAfnanW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *٭ المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ▪︎' and DevAfnanW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *٭ الجروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ▪︎") and DevAfnanW(msg) then
...
if text == ("قائمه العام ▪︎") and DevAfnanW(msg) then
...
if text == ("قائمه الكتم العام ▪︎") and DevAfnanW(msg) then
...
if text=="اذاعه خاص ▪︎" and msg.reply_to_message_id_ == 0 and DevAfnanW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *٭ ارسل الان اذاعتك؟* \n*٭ للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ▪︎" and msg.reply_to_message_id_ == 0 and DevAfnanW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *٭ ارسل الان اذاعتك؟* \n*٭ للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ▪︎" and msg.reply_to_message_id_ == 0 and DevAfnanW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *٭ ارسل الان اذاعتك؟* \n*٭ للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ▪︎" and msg.reply_to_message_id_ == 0  and DevAfnanW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *٭ ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ▪︎" and msg.reply_to_message_id_ == 0  and DevAfnanW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ٭ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ▪︎' and DevAfnanW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ▪︎" and DevAfnanW(msg) then
...
if text == "تنظيف الجروبات ▪︎" and DevAfnanW(msg) then 
...
if text == "حذف رساله الاشتراك ▪︎" and DevAfnanW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *٭ تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ▪︎$") and DevAfnanW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *٭ حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ▪︎" and DevAfnanW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ▪︎" and DevAfnanW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *٭ تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ▪︎" and DevAfnanW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
*ٴ•━━━━━━ 𝙵𝙺 ━━━━━━━•*
 *▪︎~⪼الالعاب الخاصه بسورس*
*ٴ•━━━━━━ 𝙵𝙺 ━━━━━━━•*
 *▪︎~⪼لعبه البات ↞ لعبة المحيبس* 
 *▪︎~⪼لعبه التخمين ↞ لعبة البحث*
*▪︎~⪼لعبه الاسرع ↞ اسرع شخص*
 *▪︎~⪼لعبه السمايلات ↞ لعبة المطابقه* 
 *▪︎~⪼لعبه المختلف ↞ لعبة الذكاء*
 *▪︎~⪼لعبه الرياضيات ↞ لعبة الارقام*
 *▪︎~⪼لعبه الانكليزي ↞ لعبة ترجمه*
 *▪︎~⪼لعبه الامثله ↞ لعبة تصحيح* 
*▪︎~⪼لعبه العكس ↞ عكس الكلمات*
...
send(msg.chat_id_, msg.id_,' *▪︎︙حل المسأله الرياضيه*  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' *▪︎︙ترجم الكلمات الاتيه*  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"*تم تنظيف الميديا ▪︎*")
end
...
send(msg.chat_id_, msg.id_,"\n *▪︎ تم تنزيل الشخص من جميع الرتب *")
else
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/jffgcffg/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
Text = [[
*▪︎اهلا انتツفي اوامر البوت▪︎*
ٴ*•━━━━━━ 𝙵𝙺 ━━━━━━━•*ٴ
*▪︎م1 ◂ اوامر الحمايه*
*▪︎م2 ◂ اوامر تعطيل ~ تفعيل*
*▪︎م3 ◂ اوامر ضع ~ اضف*
*▪︎م4 ◂ اوامر مسح ~ حذف*
*▪︎م5 ◂ اوامر تنزيل+رفع+التغير*
*▪︎م6 ◂ اوامر الجروب*
*▪︎م7 ◂ اوامر التحشيش*
*▪︎م8 ◂ اوامر مطور البوت*
*▪︎م9 ◂ اوامر مطور الاساسي* 
*▪︎م10 ◂ اوامر الاعضاء*
ٴ*•━━━━━━ 𝙵𝙺 ━━━━━━━•*ٴ
[- 𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙺⁦ ](t.me/saaaa) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
send(msg.chat_id_, msg.id_, t..'ٴ▪︎∫ٴ*•━━━━━━ 𝙵𝙺 ━━━━━━━•*ٴ▪︎∫○ٴ\n٭ [- 𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙺⁦](t.me/saaaa) ')
end
...
t =[[
*رابط الحذف في جميع مواقع التواصل ▪︎
فكر قبل لا تتسرع وتروح*
ٴ*•━━━━━━ 𝙵𝙺 ━━━━━━━•*ٴ
 *▪︎ رابط حذف*  [Telegram](https://my.telegram.org/auth?to=delete) ܁
 *▪︎ رابط حذف* [instagram](https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/) ܁
 *▪︎ رابط حذف* [Facebook](https://www.facebook.com/help/deleteaccount) ܁
 *▪︎ رابط حذف* [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
local notText = '▪︎ عذرا الاوامر هذه لا تخصك'
...
local Text ="*▪︎ تم الغاء منعها بنجاح*"
inline = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙺⁦',url='http://t.me/saaaa'}},
}
...
local Text ="*▪︎ تم الغاء منعه بنجاح*"
inline = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙺⁦',url='http://t.me/saaaa'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
local Text ="*▪︎ تم الغاء منع كل المتحركات*"
inline = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙺⁦',url='http://t.me/saaaa'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
local Text ="*▪︎ تم الغاء منع كل الصور*"
inline = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙺⁦',url='http://t.me/saaaa'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
local Text ="*▪︎ تم الغاء الطرد بنجاح .*"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙵𝙺⁦',url='http://t.me/saaaa'}},
}
